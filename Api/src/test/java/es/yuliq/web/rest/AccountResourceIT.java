...
import static es.yuliq.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import es.yuliq.IntegrationTest;
import es.yuliq.config.Constants;
import es.yuliq.domain.User;
import es.yuliq.repository.AuthorityRepository;
import es.yuliq.repository.UserRepository;
import es.yuliq.security.AuthoritiesConstants;
import es.yuliq.service.UserService;
import es.yuliq.service.dto.AdminUserDTO;
import es.yuliq.service.dto.PasswordChangeDTO;
import es.yuliq.service.dto.UserDTO;
import es.yuliq.web.rest.vm.KeyAndPasswordVM;
import es.yuliq.web.rest.vm.ManagedUserVM;
